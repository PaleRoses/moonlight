...
data RoundProgramCompilation u = RoundProgramCompilation
  { rpcFactRules ::
      !( Either
           ...
           [(SupportIndexedRule (SupportBasis (SatContext u)) (SatFactRule u), SupportCarrier (SatContextOwner u) (SatContext u))]
       ),
    rpcRewriteRules ::
      !( Either
           (PreparedContextSupportError (SatContext u))
...
contextualizeCompiledRules ::
  ...
  Set.Set context ->
  [(SupportIndexedRule (SupportBasis context) rule, SupportCarrier owner context)] ->
...
preparedActiveContexts ::
  ...
  PreparedContextSite owner context ->
  Set.Set context ->
  [(context, ContextObjectKey owner)]
...
compileSupportedRules ::
  ...
  PreparedContextSite owner context ->
  [SupportIndexedRule (SupportBasis context) rule] ->
  Either (PreparedContextSupportError context) [(SupportIndexedRule (SupportBasis context) rule, SupportCarrier owner context)]
...
activeCompiledRulesAt ::
  ...
  [(SupportIndexedRule support rule, SupportCarrier owner context)] ->
  [rule]
