...
compileSupportProgram ::
  ...
  SheafTwist.SupportedRuleBook (SatContextOwner u) (SatContext u) (SatRuleSource u) ->
  SheafTwist.SupportedFactBook (SatContextOwner u) (SatContext u) (SatFactSource u) ->
  Either
