...
type HsExprBindingCorpus :: Type
data HsExprBindingCorpus = HsExprBindingCorpus
  { hbcRules :: !(SheafTwist.SupportedRuleBook ScopeCtx HsExprBindingRule),
    hbcFacts :: !(SheafTwist.SupportedFactBook ScopeCtx HsExprBindingFactRule),
...
hsExprBindingCorpus ::
  ...
  ConvertedModule ->
  Either HsExprBindingFrontError HsExprBindingCorpus
