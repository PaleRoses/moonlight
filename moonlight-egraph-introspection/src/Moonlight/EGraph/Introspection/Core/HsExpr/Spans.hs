...
contextStructureSnapshot :: ContextEGraph f a c -> ContextStructureSnapshot
  ...
  let contextAnalysisDeltas =
   ...
   in ContextStructureSnapshot
        { cssActiveContextCount = Map.size contextAnalysisDeltas,
          cssRestrictionCount = length (preparedRestrictionPairs (cegSite contextGraph)),
...
insertScopedExprWithSupport ::
  ...
  Either
    ...
    (ClassId, a, ContextEGraph HsExprF a ScopeCtx)
...
insertScopedExprWithSupportMetrics ::
  ...
  Either
    (ContextDeltaError HsExprF ScopeCtx)
    (ClassId, a, ScopedInsertionMetrics, ContextEGraph HsExprF a ScopeCtx)
...
insertConvertedModule ::
  ...
  ConvertedModule ->
  ContextEGraph HsExprF a ScopeCtx ->
  Either HsExprInsertionError ([ClassId], [SpanClassRow], ContextEGraph HsExprF a ScopeCtx)
...
insertConvertedModuleWithMetrics ::
  ...
  Either
    HsExprInsertionError
    ([ClassId], [SpanClassRow], HsExprInsertionMetrics, ContextEGraph HsExprF a ScopeCtx)
...
insertConvertedModuleBase ::
  ...
  Either
    HsExprInsertionError
    ([ClassId], [SpanClassRow], ScopedInsertionMetrics, ContextRebaseBatch HsExprF a ScopeCtx)
...
insertTopLevelSpannedExprWithDeferredRefreshMetrics ::
  ...
  Either
    HsExprInsertionError
    (ClassId, a, [SpanClassRow], ScopedInsertionMetrics, ContextRebaseBatch HsExprF a ScopeCtx)
insertTopLevelSpannedExprWithDeferredRefreshMetrics =
...
supportContextWidthWith :: ClosedExpressionSupport -> ScopeIndex -> PreparedContextSite ScopeCtx -> ScopedExpr -> Int
