...
import Moonlight.Category qualified as Category
      ...
      let familyValue = SheafContextPresentation.contextPresentation rewriteSystem
          ...
          missingIdentities =
            familyObjects
              & traverse
                ( \objectValue ->
                    case Category.identity familyCategory objectValue of
                      Left categoryError ->
...
missingCompositeWitnesses categoryValue morphismSet leftMorphism =
  foldMap
    (\rightMorphism ->
        case Category.compose categoryValue leftMorphism rightMorphism of
