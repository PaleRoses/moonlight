...
extractBounded :: (Language f, Ord cost) => ExtractionWorkBudget -> CostAlgebra f cost -> ClassId -> StableExtractionSnapshot f a -> Either ExtractionBudgetExhaustion (Maybe (ExtractionResult f cost))
...
extractAllBounded :: (Language f, Ord cost) => ExtractionWorkBudget -> CostAlgebra f cost -> StableExtractionSnapshot f a -> Either ExtractionBudgetExhaustion (IntMap (ExtractionResult f cost))
...
extractWithAnalysisBounded :: (Language f, Ord cost) => ExtractionWorkBudget -> AnalysisCostAlgebra f a cost -> ClassId -> StableExtractionSnapshot f a -> Either ExtractionBudgetExhaustion (Maybe (ExtractionResult f cost))
...
extractAllWithAnalysisBounded :: (Language f, Ord cost) => ExtractionWorkBudget -> AnalysisCostAlgebra f a cost -> StableExtractionSnapshot f a -> Either ExtractionBudgetExhaustion (IntMap (ExtractionResult f cost))
