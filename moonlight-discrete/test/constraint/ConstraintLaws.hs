...
effectLawBundle =
  quickCheckLawBundle
    ...
    [ quickCheckLawDefinition (CommonLaw NormalizeIdempotent) (normalizeIdempotent @Atom),
      ...
      quickCheckLawDefinition HeytingImplication
        ( \(left :: ConstraintExpr Atom) (right :: ConstraintExpr Atom) ->
      ...
      quickCheckLawDefinition CoFiniteTruthNormalizationIdempotent
        (coFiniteTruthNormalizationIdempotent @Atom),
