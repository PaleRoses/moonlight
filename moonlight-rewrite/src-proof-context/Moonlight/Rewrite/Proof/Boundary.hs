...
newtype ProofTheoremName = ProofTheoremName String
  deriving stock (Eq, Ord, Show)

proofTheoremNameString :: ProofTheoremName -> String
proofTheoremNameString (ProofTheoremName theoremName) =
  theoremName
...
newtype ProofTheoremManifest = ProofTheoremManifest [ProofTheoremName]
  deriving stock (Eq, Ord, Show)

proofTheoremManifestTheorems :: ProofTheoremManifest -> [ProofTheoremName]
proofTheoremManifestTheorems (ProofTheoremManifest theoremNames) =
  theoremNames
