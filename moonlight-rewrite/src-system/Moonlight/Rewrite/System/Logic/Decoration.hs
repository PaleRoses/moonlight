        ...
        Right
          LogicalDecoration
            { ldCondition = projectCompiledGuard projection <$> ldCondition decoration,
              ldApplicationCondition =
                projectCompiledApplicationCondition projection <$> ldApplicationCondition decoration,
...
renameCompiledApplicationCondition :: (Functor f, Ord capability, forall a. Ord a => Ord (f a)) => PatternRenaming -> CompiledApplicationCondition (CompiledGuard capability f) f -> CompiledApplicationCondition (CompiledGuard capability f) f
renameCompiledApplicationCondition = mapCompiledApplicationConditionExtensions . renameCompiledPatternExtension

renameCompiledPatternExtension :: (Functor f, Ord capability, forall a. Ord a => Ord (f a)) => PatternRenaming -> CompiledPatternExtension (CompiledGuard capability f) f -> CompiledPatternExtension (CompiledGuard capability f) f
renameCompiledPatternExtension renaming extension =
  mapCompiledPatternExtension
    (renamePatternVariableSet renaming)
    (renamePattern renaming)
    (renameCompiledGuard renaming)
    extension

projectCompiledApplicationCondition :: (Functor f, Foldable f, Ord capability, forall a. Ord a => Ord (f a)) => PatternProjection f -> CompiledApplicationCondition (CompiledGuard capability f) f -> CompiledApplicationCondition (CompiledGuard capability f) f
projectCompiledApplicationCondition = mapCompiledApplicationConditionExtensions . projectCompiledPatternExtension

projectCompiledPatternExtension :: (Functor f, Foldable f, Ord capability, forall a. Ord a => Ord (f a)) => PatternProjection f -> CompiledPatternExtension (CompiledGuard capability f) f -> CompiledPatternExtension (CompiledGuard capability f) f
...
mapCompiledPatternExtension :: (Set.Set PatternVar -> Set.Set PatternVar) -> (Pattern f -> Pattern f) -> (CompiledGuard capability f -> CompiledGuard capability f) -> CompiledPatternExtension (CompiledGuard capability f) f -> CompiledPatternExtension (CompiledGuard capability f) f
mapCompiledPatternExtension transformAnchorVars transformPattern transformGuard extension =
  extension
    { cpeQuery =
        mapCompiledPatternQuery
          transformPattern
          transformGuard
          (cpeQuery extension),
      cpeAnchorVars = transformAnchorVars (cpeAnchorVars extension)
    }
