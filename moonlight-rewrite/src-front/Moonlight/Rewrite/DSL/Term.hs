...
-- | Typed term and variable surface for the front DSL.
-- Owns sort names, type-level symbol tokens, typed variables, existential
-- variables, and the variable/node term GADT.
-- Contract: terms record sort information but do not validate rule scope or
-- groundness; those checks happen at later boundaries.
