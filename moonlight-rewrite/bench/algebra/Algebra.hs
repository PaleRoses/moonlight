      ...
      env pbpoFixture $ \fixture ->
        bgroup
          ...
          [ bench "derived rule objects" (nf derivedRuleObjectsWeight fixture),
            ...
            bench "admitPBPOUnit" (nf admitPBPOUnitWeight (41 :: Int))
          ]
    ]
  ...
  pbpoFixture >>= \fixture ->
    sequence_
      [ void (expectBench "derived interface" (pbpoRuleInterface RefCat (pfPermissiveRule fixture))),
        ...
        void (expectBench "admitPBPOUnit" (admitPBPOUnit ("unit failure" :: String) ("unit source" :: String) (41 :: Int) Right)),
...
admitPBPOUnitWeight :: Int -> Maybe Int
admitPBPOUnitWeight seed =
  either (const Nothing) Just $
    admitPBPOUnit ("unit failure" :: String) ("unit source" :: String) seed Right
