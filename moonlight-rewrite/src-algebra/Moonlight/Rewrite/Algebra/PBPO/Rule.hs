...
pbpoRuleMeta :: PBPORule c meta -> meta
pbpoRuleMeta (PBPORule metaValue _leftLeg _rightLeg _leftTyping _interfaceTyping _contextLeg) =
  metaValue

pbpoRuleLeftLeg :: PBPORule c meta -> Mor c
pbpoRuleLeftLeg (PBPORule _metaValue leftLeg _rightLeg _leftTyping _interfaceTyping _contextLeg) =
  leftLeg

pbpoRuleRightLeg :: PBPORule c meta -> Mor c
pbpoRuleRightLeg (PBPORule _metaValue _leftLeg rightLeg _leftTyping _interfaceTyping _contextLeg) =
  rightLeg

pbpoRuleLeftTyping :: PBPORule c meta -> Mor c
pbpoRuleLeftTyping (PBPORule _metaValue _leftLeg _rightLeg leftTyping _interfaceTyping _contextLeg) =
  leftTyping

pbpoRuleInterfaceTyping :: PBPORule c meta -> Mor c
pbpoRuleInterfaceTyping (PBPORule _metaValue _leftLeg _rightLeg _leftTyping interfaceTyping _contextLeg) =
  interfaceTyping

pbpoRuleContextLeg :: PBPORule c meta -> Mor c
pbpoRuleContextLeg (PBPORule _metaValue _leftLeg _rightLeg _leftTyping _interfaceTyping contextLeg) =
  contextLeg
