...
data CompositionResult atom dec f = CompositionResult
  { crRewrite :: !(PatternRewrite atom dec f),
    ...
    crRightFreshening :: !PatternRenaming,
    crLeftProjection :: !(PatternProjection f),
    crRightProjection :: !(PatternProjection f)
  }
          ...
          Right
            CompositionResult
              { crRewrite = composedRewrite,
                ...
                crRightFreshening = rightRenaming,
                crLeftProjection = leftProjection,
                crRightProjection = rightProjection
              }
