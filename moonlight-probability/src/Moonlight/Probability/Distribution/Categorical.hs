...
uniformCategorical :: Ord a => NonEmpty a -> Either CategoricalError (Categorical a)
uniformCategorical = fmap Categorical . first mapFiniteDistributionError . uniformFiniteDistribution
