...
data CosheafChainBasisTable site value = CosheafChainBasisTable
  { cosheafChainBasisDegreeInternal :: !HomologicalDegree,
    cosheafChainBasisCellsInternal :: !(Vector (CosheafChainCell (SiteObject site) (SiteMorphism site) value)),
    cosheafChainBasisIndexByKeyInternal :: !(Map CosheafChainBasisKey Int),
    cosheafChainBasisKeyByIndexInternal :: !(IntMap CosheafChainBasisKey)
  }
...
data PreparedFiniteCosheafChain site value = PreparedFiniteCosheafChain
  { preparedFiniteCosheafInternal :: !(FiniteCosheaf site value),
    preparedFiniteCosheafMaxDegreeInternal :: !HomologicalDegree,
    preparedFiniteCosheafBasisByDegreeInternal :: !(IntMap (CosheafChainBasisTable site value)),
    preparedFiniteCosheafBoundariesByDegreeInternal :: !(IntMap (BoundaryIncidence Int)),
    preparedFiniteCosheafChainComplexInternal :: !(FiniteChainComplex Int)
  }
...
cosheafChainBasisTableSize =
  Vector.length . cosheafChainBasisCellsInternal
