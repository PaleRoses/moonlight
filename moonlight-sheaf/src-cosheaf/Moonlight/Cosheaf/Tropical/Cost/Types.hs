...
data TropicalCostTable site value = TropicalCostTable
  { tctColimit :: !(CosheafColimit site value),
    tctRepresentativeCosts :: !(IntMap MinPlusWeight),
    tctTransitions :: ![TropicalWeightedTransition (SiteObject site) (SiteMorphism site) value]
  }
...
data TropicalCosectionPlan site value = TropicalCosectionPlan
  { tcpCostTable :: !(TropicalCostTable site value),
    tcpClassChoices :: !(IntMap (TropicalClassChoice (SiteObject site) value))
  }
