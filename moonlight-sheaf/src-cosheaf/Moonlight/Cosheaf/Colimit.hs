...
data CosheafColimit site value = CosheafColimit
  { cosheafColimitCosheafInternal :: !(FiniteCosheaf site value),
    cosheafColimitRepresentativeIndexInternal :: !(DenseIndex CosectionRepKey (CosectionRepresentative (SiteObject site) value)),
    cosheafColimitEquivalenceInternal :: !(EquivalenceRelation CosectionRepKey)
  }
...
ccCosheaf :: CosheafColimit site value -> FiniteCosheaf site value
ccCosheaf =
  cosheafColimitCosheafInternal

ccRepresentativeIndex ::
  CosheafColimit site value ->
  DenseIndex CosectionRepKey (CosectionRepresentative (SiteObject site) value)
ccRepresentativeIndex =
  cosheafColimitRepresentativeIndexInternal

ccEquivalence :: CosheafColimit site value -> EquivalenceRelation CosectionRepKey
ccEquivalence =
  cosheafColimitEquivalenceInternal
...
finiteCosheafColimitFromPreparedSupport preparedSupport = do
  ...
  let representativeIndex = mkDenseIndex representatives
  let representativeKeysByCostalk =
  ...
  pure
    CosheafColimit
      { cosheafColimitCosheafInternal = cosheaf,
        cosheafColimitRepresentativeIndexInternal = representativeIndex,
        cosheafColimitEquivalenceInternal = relationValue
      }
  where
    cosheaf =
