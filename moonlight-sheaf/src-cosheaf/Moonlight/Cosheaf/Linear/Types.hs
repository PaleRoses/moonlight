...
data LinearCosheaf site basis coeff = LinearCosheaf
  { linearCosheafSiteInternal :: !site,
    linearCosheafSiteIndexInternal :: !(CosheafSiteIndex site),
    linearCosheafCostalksInternal :: !(IntMap (LinearCostalk (SiteObject site) basis)),
    linearCosheafCorestrictionsInternal :: !(IntMap (LinearCorestriction (SiteObject site) (SiteMorphism site) coeff))
  }
