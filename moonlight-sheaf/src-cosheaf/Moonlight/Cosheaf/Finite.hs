...
data FiniteCostalk obj value = FiniteCostalk
  { finiteCostalkObjectInternal :: !obj,
    finiteCostalkValuesInternal :: !(DenseIndex CostalkKey value)
  }
  deriving stock (Eq, Show)

fcostalkObject :: FiniteCostalk obj value -> obj
fcostalkObject = finiteCostalkObjectInternal

fcostalkValues :: FiniteCostalk obj value -> DenseIndex CostalkKey value
fcostalkValues = finiteCostalkValuesInternal
...
data CompiledCorestriction obj mor = CompiledCorestriction
  { compiledCorestrictionMorphismKeyInternal :: !CosheafMorphismKey,
    compiledCorestrictionMorphismInternal :: !(CheckedMorphism obj mor),
    compiledCorestrictionSourceObjectKeyInternal :: !ObjectKey,
    compiledCorestrictionTargetObjectKeyInternal :: !ObjectKey,
    compiledCorestrictionSourceToTargetInternal :: !(IntMap CostalkKey)
  }
  deriving stock (Eq, Show)

ccMorphismKey :: CompiledCorestriction obj mor -> CosheafMorphismKey
ccMorphismKey = compiledCorestrictionMorphismKeyInternal

ccMorphism :: CompiledCorestriction obj mor -> CheckedMorphism obj mor
ccMorphism = compiledCorestrictionMorphismInternal

ccSourceObjectKey :: CompiledCorestriction obj mor -> ObjectKey
ccSourceObjectKey = compiledCorestrictionSourceObjectKeyInternal

ccTargetObjectKey :: CompiledCorestriction obj mor -> ObjectKey
ccTargetObjectKey = compiledCorestrictionTargetObjectKeyInternal

ccSourceToTarget :: CompiledCorestriction obj mor -> IntMap CostalkKey
ccSourceToTarget = compiledCorestrictionSourceToTargetInternal

type FiniteCosheaf :: Type -> Type -> Type
data FiniteCosheaf site value = FiniteCosheaf
  { finiteCosheafSiteInternal :: !site,
    finiteCosheafSiteIndexInternal :: !(CosheafSiteIndex site),
    finiteCosheafCostalksInternal :: !(IntMap (FiniteCostalk (SiteObject site) value)),
    finiteCosheafCorestrictionsInternal :: !(IntMap (CompiledCorestriction (SiteObject site) (SiteMorphism site)))
  }
...
fcSite :: FiniteCosheaf site value -> site
fcSite =
  finiteCosheafSiteInternal

fcSiteIndex :: FiniteCosheaf site value -> CosheafSiteIndex site
fcSiteIndex =
  finiteCosheafSiteIndexInternal

fcCostalks :: FiniteCosheaf site value -> IntMap (FiniteCostalk (SiteObject site) value)
fcCostalks =
  finiteCosheafCostalksInternal

fcCorestrictions ::
  FiniteCosheaf site value ->
  IntMap (CompiledCorestriction (SiteObject site) (SiteMorphism site))
fcCorestrictions =
  finiteCosheafCorestrictionsInternal
...
mkFiniteCosheaf site algebra rawCostalks = do
  ...
  let cosheaf =
        FiniteCosheaf
          { finiteCosheafSiteInternal = site,
            finiteCosheafSiteIndexInternal = siteIndex,
            finiteCosheafCostalksInternal = costalks,
            finiteCosheafCorestrictionsInternal = corestrictions
          }
      ...
      case duplicatesOrd values of
        ...
        [] ->
          Right
            ...
            FiniteCostalk
                { finiteCostalkObjectInternal = objectValue,
                  finiteCostalkValuesInternal = mkDenseIndex values
                }
            )
    ...
    compileCorestriction costalks indexedMorphism = do
      ...
      pure
        ( encodeDenseKey (icmKey indexedMorphism),
          CompiledCorestriction
            { compiledCorestrictionMorphismKeyInternal = icmKey indexedMorphism,
              compiledCorestrictionMorphismInternal = morphismValue,
              compiledCorestrictionSourceObjectKeyInternal = icmSourceObjectKey indexedMorphism,
              compiledCorestrictionTargetObjectKeyInternal = icmTargetObjectKey indexedMorphism,
              compiledCorestrictionSourceToTargetInternal = sourceToTarget
            }
        )
      where
        morphismValue =
