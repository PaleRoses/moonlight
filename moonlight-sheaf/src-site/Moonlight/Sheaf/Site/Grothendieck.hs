...
data GrothendieckCell system = GrothendieckCell
  { grothendieckCellKeyInternal :: GrothendieckCellKey,
    grothendieckCellSimplexInternal :: NerveSimplex (GrothendieckCategory system)
  }
...
data GrothendieckFaceMorphism system = GrothendieckFaceMorphism
  { grothendieckFaceMorphismSourceInternal :: GrothendieckCell system,
    grothendieckFaceMorphismTargetInternal :: GrothendieckCell system,
    grothendieckFaceMorphismKindInternal :: FaceKind,
    grothendieckFaceMorphismFaceIndexInternal :: Natural,
    grothendieckFaceMorphismOrientationInternal :: Int
  }
...
data GrothendieckSite system = GrothendieckSite
  { grothendieckSiteDepthInternal :: Natural,
    grothendieckSiteSourceNerveInternal :: TruncatedNormalizedSSet (NerveSimplex (GrothendieckCategory system)),
    grothendieckSiteCellsInternal :: [GrothendieckCell system],
    grothendieckSiteCellsByDimension :: Map Natural [GrothendieckCell system],
    grothendieckSiteBasisInternal :: SheafBasis (GrothendieckCell system),
    grothendieckSiteFaceMorphismsInternal :: [GrothendieckFaceMorphism system]
  }

grothendieckCellKey :: GrothendieckCell system -> GrothendieckCellKey
grothendieckCellKey = grothendieckCellKeyInternal

grothendieckCellSimplex :: GrothendieckCell system -> NerveSimplex (GrothendieckCategory system)
grothendieckCellSimplex = grothendieckCellSimplexInternal

grothendieckFaceMorphismSource :: GrothendieckFaceMorphism system -> GrothendieckCell system
grothendieckFaceMorphismSource = grothendieckFaceMorphismSourceInternal

grothendieckFaceMorphismTarget :: GrothendieckFaceMorphism system -> GrothendieckCell system
grothendieckFaceMorphismTarget = grothendieckFaceMorphismTargetInternal

grothendieckFaceMorphismKind :: GrothendieckFaceMorphism system -> FaceKind
grothendieckFaceMorphismKind = grothendieckFaceMorphismKindInternal

grothendieckFaceMorphismFaceIndex :: GrothendieckFaceMorphism system -> Natural
grothendieckFaceMorphismFaceIndex = grothendieckFaceMorphismFaceIndexInternal

grothendieckFaceMorphismOrientation :: GrothendieckFaceMorphism system -> Int
grothendieckFaceMorphismOrientation = grothendieckFaceMorphismOrientationInternal

grothendieckSiteDepth :: GrothendieckSite system -> Natural
grothendieckSiteDepth = grothendieckSiteDepthInternal

grothendieckSiteSourceNerve :: GrothendieckSite system -> TruncatedNormalizedSSet (NerveSimplex (GrothendieckCategory system))
grothendieckSiteSourceNerve = grothendieckSiteSourceNerveInternal

grothendieckSiteCells :: GrothendieckSite system -> [GrothendieckCell system]
grothendieckSiteCells = grothendieckSiteCellsInternal

grothendieckSiteBasis :: GrothendieckSite system -> SheafBasis (GrothendieckCell system)
grothendieckSiteBasis = grothendieckSiteBasisInternal

grothendieckSiteFaceMorphisms :: GrothendieckSite system -> [GrothendieckFaceMorphism system]
grothendieckSiteFaceMorphisms = grothendieckSiteFaceMorphismsInternal
...
grothendieckSiteFromSkeleton depthValue nerveValue skeletonValue =
  let cells = tssCells skeletonValue
   in GrothendieckSite
        { grothendieckSiteDepthInternal = depthValue,
          grothendieckSiteSourceNerveInternal = nerveValue,
          grothendieckSiteCellsInternal = cells,
          grothendieckSiteCellsByDimension = tssCellsByDimension skeletonValue,
          grothendieckSiteBasisInternal = mkSheafBasis cells,
          grothendieckSiteFaceMorphismsInternal = tssFaceMorphisms skeletonValue
        }
...
mkGrothendieckCell _ ordinal simplexValue =
  GrothendieckCell
    { grothendieckCellKeyInternal =
        GrothendieckCellKey
          { gckDimension = nerveSimplexDimension simplexValue,
            gckOrdinal = ordinal
          },
      grothendieckCellSimplexInternal = simplexValue
    }
...
mkGrothendieckFaceMorphism sourceCellValue targetCellValue faceKindValue faceIndex orientationValue =
  GrothendieckFaceMorphism
    { grothendieckFaceMorphismSourceInternal = sourceCellValue,
      grothendieckFaceMorphismTargetInternal = targetCellValue,
      grothendieckFaceMorphismKindInternal = faceKindValue,
      grothendieckFaceMorphismFaceIndexInternal = faceIndex,
      grothendieckFaceMorphismOrientationInternal = orientationValue
    }
      ...
      Just
        GrothendieckCell
          { grothendieckCellKeyInternal =
            ...
            grothendieckCellSimplexInternal =
