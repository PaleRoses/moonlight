...
import Moonlight.Sheaf.TestFixture.Branch.Site (branchRootCover, branchSite)
...
ghostLeafToRoot =
  CheckedMorphism Leaf Root GhostLeafToRoot
...
matchingBranchFamily rightStalk = do
  coverValue <- first show branchRootCover
