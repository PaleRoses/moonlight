  ...
  testGroup
    ...
    [ testCase "Moonlight.Sheaf root exports are curated and locked" testRootExportsAreLocked,
      ...
      testGroup
        ...
        (fmap recordFieldLockTest representativeRecordFieldLocks)
    ]

recordFieldLockTest :: RecordFieldSurfaceLock -> TestTree
recordFieldLockTest lock =
  testCase (rfslProjectionName lock <> " is a projection, not a field label")
    (assertRecordFieldSurfaceLocked lock)

representativeRecordFieldLocks :: [RecordFieldSurfaceLock]
representativeRecordFieldLocks =
  [ RecordFieldSurfaceLock
      { rfslLabel = "IncidenceCoefficient",
        rfslSourceCandidates = sourceCandidates "src-core/Moonlight/Sheaf/Section/Morphism.hs",
        rfslProjectionName = "incidenceCoefficientValue"
      },
    RecordFieldSurfaceLock
      { rfslLabel = "GlobalSection",
        rfslSourceCandidates = sourceCandidates "src-core/Moonlight/Sheaf/Section/Certified.hs",
        rfslProjectionName = "globalUnderlyingSection"
      },
    RecordFieldSurfaceLock
      { rfslLabel = "GradedOperator",
        rfslSourceCandidates = sourceCandidates "src-core/Moonlight/Sheaf/Operator/GradedComplex.hs",
        rfslProjectionName = "gradedOperatorIncidence"
      },
    RecordFieldSurfaceLock
      { rfslLabel = "FiniteCosheaf",
        rfslSourceCandidates = sourceCandidates "src-cosheaf/Moonlight/Cosheaf/Finite.hs",
        rfslProjectionName = "fcCorestrictions"
      }
  ]

sourceCandidates :: FilePath -> [FilePath]
sourceCandidates packageRelativePath =
  [ packageRelativePath,
    "foundation/moonlight-sheaf/" <> packageRelativePath,
    "compiler/foundation/moonlight-sheaf/" <> packageRelativePath
  ]
      ...
      { eslLabel = "Moonlight.Sheaf root",
        ...
        eslSourceCandidates =
          [ "src-public/Moonlight/Sheaf.hs",
            "foundation/moonlight-sheaf/src-public/Moonlight/Sheaf.hs",
      ...
      { eslLabel = "Moonlight.Sheaf.Presentation",
        ...
        eslSourceCandidates =
          [ "src-public/Moonlight/Sheaf/Presentation.hs",
            "foundation/moonlight-sheaf/src-public/Moonlight/Sheaf/Presentation.hs",
