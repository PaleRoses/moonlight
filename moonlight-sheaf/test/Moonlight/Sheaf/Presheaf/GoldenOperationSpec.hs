...
goldenGluing :: GluingAlgebra GoldenSite GoldenStalk GoldenGluingFailure
goldenGluing =
  GluingAlgebra
...
withGoldenPreparedSite :: (GoldenSite -> PreparedSite GoldenSite -> Assertion) -> Assertion
...
withGoldenPreparedSiteFromSpec ::
  ...
  (GoldenSite -> PreparedSite GoldenSite -> Assertion) ->
  Assertion
withGoldenPreparedSiteFromSpec finiteMeetSpec continue =
  withGoldenSiteFromSpec finiteMeetSpec $ \site ->
    case compile (siteSpec site) of
      Left failure ->
        assertFailure ("expected golden site preparation to succeed, received " <> show failure)
      Right preparedSite ->
        continue site preparedSite

withGoldenCoverPlan :: PreparedSite GoldenSite -> (PreparedCover GoldenSite -> Assertion) -> Assertion
...
withGoldenSection :: PreparedSite GoldenSite -> Int -> (Section GoldenSite GoldenStalk -> Assertion) -> Assertion
...
expectGoldenCompatibleFamily ::
  GoldenSite ->
  PreparedCover GoldenSite ->
  Vector GoldenStalk ->
  (CompatibleMatchingFamily GoldenSite GoldenStalk -> Assertion) ->
  Assertion
