...
type PreparedCongruenceSiteModel :: Type -> Type -> Type -> Type -> Type -> Type
data PreparedCongruenceSiteModel carrier owner site rep atom = PreparedCongruenceSiteModel
  { pcsmSite :: !site,
    pcsmCarrier :: !(GlobalCarrier rep atom),
    pcsmPreparedModel :: !(PreparedCongruenceModel carrier owner (SiteObject site) rep atom),
...
prepareCongruenceSiteModelWith ::
  ...
  (forall carrier owner. PreparedCongruenceSiteModel carrier owner site rep atom -> result) ->
...
finiteCongruencePresheafFromRelations ::
  (Site site, Ord (SiteMorphism site), DenseKey rep) =>
  PreparedCongruenceSiteModel carrier owner site rep atom ->
