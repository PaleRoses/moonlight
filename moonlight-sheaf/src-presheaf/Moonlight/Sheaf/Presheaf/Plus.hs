...
-- | The plus construction: separated-presheaf classes, representatives, and
-- the enumeration machinery sheafification runs twice.
...
plusConstruction budget basis presheaf = do
  ...
  where
    ...
    orderedCoverDomains ::
      IntMap [OverlapPlan (SiteObject site) (SiteMorphism site)] ->
      [CoverAssignmentDomain value] ->
      [CoverAssignmentDomain value]
    ...
    signedRepresentative ::
      ...
      EffectiveCoverPlan (SiteObject site) (SiteMorphism site) ->
      PartialCoverAssignment value ->
      SignedPlusRepresentative site value
    ...
    representativeSignatureIndex ::
      [(PlusKey, PlusRepresentativeSignature (SiteObject site) (SiteMorphism site))] ->
      Map (PlusRepresentativeSignature (SiteObject site) (SiteMorphism site)) [PlusKey]
    ...
    representativeCoverPairRequests ::
      IntMap (PlusRepresentative site value) ->
      [ ( (Int, Int)
        , EffectiveCoverPlan (SiteObject site) (SiteMorphism site)
        , EffectiveCoverPlan (SiteObject site) (SiteMorphism site)
        , [(Int, PlusRepresentative site value)]
        , [(Int, PlusRepresentative site value)]
        )
      ]
    representativeCoverPairRequests representatives =
    ...
    firstOrderedKeyPair :: [Int] -> [Int] -> Maybe (Int, Int)
    ...
    representativeCommonSignatureGroups ::
      (PlusRepresentative site value -> Maybe PlusCommonSignature) ->
      [(Int, PlusRepresentative site value)] ->
      Map PlusCommonSignature [Int]
