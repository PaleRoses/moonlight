...
benchOperation ::
  SomeOperationBenchEnv ->
  String ->
  (forall owner multiOwner. OperationBenchEnv owner multiOwner -> OperationMeasure) ->
  Benchmark
benchOperation benchEnv label runOperation =
  bench label (nf (runSomeOperationBench runOperation) benchEnv)

runSomeOperationBench ::
  (forall owner multiOwner. OperationBenchEnv owner multiOwner -> OperationMeasure) ->
  SomeOperationBenchEnv ->
  OperationMeasure
runSomeOperationBench runOperation (SomeOperationBenchEnv benchEnv) =
  runOperation benchEnv
...
data OperationBenchEnv owner multiOwner = OperationBenchEnv
  { obeSite :: !BenchSite,
    obePreparedSite :: !(PreparedSite owner BenchSite),
    obeCoverPlan :: !(PreparedCover owner BenchSite),
    obeOverlapToLeft :: !(CheckedMorphism BenchCell (FiniteMeetMorphism BenchCell)),
    obeCompatibleFamily :: !(MatchingFamily owner BenchSite BenchStalk),
    obeObstructedFamily :: !(MatchingFamily owner BenchSite BenchStalk),
    obeMultiSite :: !MultiBenchSite,
    obeMultiCompatibleFamily :: !(MatchingFamily multiOwner MultiBenchSite MultiBenchStalk),
    obeMultiFirstObstructedFamily :: !(MatchingFamily multiOwner MultiBenchSite MultiBenchStalk),
    obeMultiLastObstructedFamily :: !(MatchingFamily multiOwner MultiBenchSite MultiBenchStalk),
    obeMultiEverywhereObstructedFamily :: !(MatchingFamily multiOwner MultiBenchSite MultiBenchStalk),
    obeCompatibleSlots :: !(Vector BenchStalk),
    obeCompatibleSection :: !(Section owner BenchSite BenchStalk),
    obeObstructedSection :: !(Section owner BenchSite BenchStalk),
...
type role OperationBenchEnv nominal nominal

data SomeOperationBenchEnv where
  SomeOperationBenchEnv :: !(OperationBenchEnv owner multiOwner) -> SomeOperationBenchEnv

instance NFData (OperationBenchEnv owner multiOwner) where
  rnf benchEnv =
    rnf
...
instance NFData SomeOperationBenchEnv where
  rnf (SomeOperationBenchEnv benchEnv) =
    rnf benchEnv
...
benchGluing :: GluingAlgebra owner BenchSite BenchStalk BenchGluingFailure
benchGluing =
  GluingAlgebra
...
setupOperationBenchEnv :: IO SomeOperationBenchEnv
setupOperationBenchEnv =
  either (ioError . userError) pure operationBenchEnv

operationBenchEnv :: Either String SomeOperationBenchEnv
operationBenchEnv = do
  ...
  preparedEnvironment <-
    showSuccess
      ( compile (siteSpec site) $ \preparedSite -> do
          ...
          multiEnvironment <-
            showSuccess
              ( compile (siteSpec multiSite) $ \multiPreparedSite -> do
...
singleCoverPlan ::
  ...
  SiteObject site ->
  Either String (PreparedCover owner site)
...
totalSectionOf :: PreparedSite owner BenchSite -> Map BenchCell BenchStalk -> Either String (Section owner BenchSite BenchStalk)
...
compatibleSlots :: PreparedCover owner BenchSite -> Vector BenchStalk
...
runRestriction :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runCompatibleOverlap :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runObstructedOverlap :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runMultiOverlapAllFailuresCompatible :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runMultiOverlapAllFailuresFirstObstructed :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runMultiOverlapAllFailuresLastObstructed :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runMultiOverlapFirstObstructionCompatible :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runMultiOverlapFirstObstructionFirstObstructed :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runMultiOverlapFirstObstructionLastObstructed :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runMultiOverlapFirstObstructionEverywhereObstructed :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
multiOverlapFailureCount :: OperationBenchEnv owner multiOwner -> MatchingFamily multiOwner MultiBenchSite MultiBenchStalk -> Int
...
multiFirstObstructionWeight :: OperationBenchEnv owner multiOwner -> MatchingFamily multiOwner MultiBenchSite MultiBenchStalk -> Int
...
runGluingDescent :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runExtensionAccepted :: OperationBenchEnv owner multiOwner -> OperationMeasure
runExtensionAccepted benchEnv =
  outcome $ do
    _global <- showSuccess (globalSection benchAlgebra (obeCompatibleSection benchEnv))
    pure 1

runExtensionObstructed :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runSectionStalkRead :: OperationBenchEnv owner multiOwner -> OperationMeasure
runSectionStalkRead benchEnv =
  outcome (stalkWeight <$> showSuccess (stalkAt BenchOverlap (obeCompatibleSection benchEnv)))

runFiniteColimitStalk :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runCertificationAccepted :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runCertificationObstructed :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runSectionVerdictCompatible :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runSectionVerdictObstructed :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runPullbackIdentity :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runPushforwardIdentity :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runContextGaloisAdjunctionReport :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runContextGaloisRestrict :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runContextGaloisExtend :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runFinitePresheafNaturalIdentity :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runPresentationCompile :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runPresentationRestriction :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runPresentationCheckedRestriction :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runFinitePresheafConstruction :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runAlignedMorphismComposition :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runSparseHomologyBasisH0 :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runSparseCohomologyBasisH0 :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runIntegralHomologyGroups :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runSheafification :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runSheafificationFirstPlus :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runSheafificationFirstPlusAsFinitePresheaf :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runSheafificationSecondPlus :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runSheafificationSecondPlusAsFinitePresheaf :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runSheafificationFiniteLawAudit :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runSheafificationUnitEvidence :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runSheafificationAssociatedReport :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runCechDenseCoboundary :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runCechNilpotenceCertification :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runCechPreparedComplexProjection :: OperationBenchEnv owner multiOwner -> OperationMeasure
...
runCechRankOneComplexBuild :: OperationBenchEnv owner multiOwner -> OperationMeasure
