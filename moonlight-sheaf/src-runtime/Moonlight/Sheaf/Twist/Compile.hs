...
type TwistCompilation :: Type -> Type -> Type -> Type -> Type -> Type -> Type -> Type -> Type
data TwistCompilation site ctx rawRule compiledRule rawFact compiledFact compiledSupport err = TwistCompilation
...
compileSupportedRuleBookWith ::
  ...
  ([rawRule] -> Either err [compiledRule]) ->
  (compiledRule -> ruleId) ->
  SupportedRuleBook context rawRule ->
...
compileSupportedFactBookWith ::
  ...
  ([rawRule] -> Either err [compiledRule]) ->
  (compiledRule -> ruleId) ->
  SupportedFactBook context rawRule ->
