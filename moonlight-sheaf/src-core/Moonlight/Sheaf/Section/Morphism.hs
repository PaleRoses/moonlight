...
newtype IncidenceCoefficient = UnsafeIncidenceCoefficient
  { incidenceCoefficientValueInternal :: Int
  }
  deriving stock (Eq, Ord, Show)

incidenceCoefficientValue :: IncidenceCoefficient -> Int
incidenceCoefficientValue =
  incidenceCoefficientValueInternal
{-# INLINE incidenceCoefficientValue #-}
