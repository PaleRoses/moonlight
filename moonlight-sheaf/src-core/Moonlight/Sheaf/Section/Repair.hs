...
data PresheafAssignment owner cell stalk mismatch witness repairObstruction = PresheafAssignment
  { paModel :: !(SheafModel owner cell witness),
    paStalkAlgebra :: !(StalkAlgebra witness stalk mismatch repairObstruction),
    paAssignment :: !(PartialSectionStore owner cell stalk)
  }

type PlainPresheafAssignment owner cell stalk mismatch repairObstruction =
  PresheafAssignment owner cell stalk mismatch () repairObstruction
...
data RepairPartialSectionResult owner cell stalk mismatch = RepairPartialSectionResult
  { repairedPartialSection :: !(PartialSectionStore owner cell stalk),
...
repairPresheafAssignment ::
  Ord cell =>
  PresheafAssignment owner cell stalk mismatch witness repairObstruction ->
  Either
    (RepairObstruction cell repairObstruction)
    (RepairPartialSectionResult owner cell stalk mismatch)
...
repairPartialSection ::
  ...
  PartialSectionStore owner cell stalk ->
  Either
    (RepairObstruction cell repairObstruction)
    (RepairPartialSectionResult owner cell stalk mismatch)
