...
relationalFactTotalSection ::
  ...
  TotalSectionStore owner ctx (CarrierFactSection ctx carrier prop boundary evidence)
...
relationalFactPartialAssignment ::
  ...
  Either
    ...
    (PartialSectionStore owner ctx (CarrierFactSection ctx carrier prop boundary evidence))
