...
emptyMathGraph :: SaturatingContextEGraph UnitContextSiteOwner SurfaceKind (PackedNode MathSig) MathDepth ()
emptyMathGraph =
  emptySaturatingContextEGraph $
...
equivalenceProgram :: Term MathSig "Expr" -> Term MathSig "Expr" -> EGraphFront 'Authored UnitContextSiteOwner MathSig MathDepth () Bool
...
expectFront :: Either (EGraphFrontError UnitContextSiteOwner MathSig MathDepth ()) value -> IO value
expectFront =
  \case
