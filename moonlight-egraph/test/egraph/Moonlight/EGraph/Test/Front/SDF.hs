...
emptySDFGraph :: SaturatingContextEGraph SurfaceKind (PackedNode SDFSig) Depth ()
emptySDFGraph =
  emptySaturatingContextEGraph $
...
saturationProgram :: RulesetM SDFSig () -> Term SDFSig "Expr" -> EGraphFront 'Authored SDFSig Depth () ()
...
equivalenceProgram :: RulesetM SDFSig () -> Term SDFSig "Expr" -> Term SDFSig "Expr" -> EGraphFront 'Authored SDFSig Depth () Bool
...
extractionProgram :: Term SDFSig "Expr" -> EGraphFront 'Authored SDFSig Depth () (Maybe (ExtractionResult (Node SDFSig) Int))
...
expectFront :: Either (EGraphFrontError SDFSig Depth ()) value -> IO value
expectFront =
  \case
