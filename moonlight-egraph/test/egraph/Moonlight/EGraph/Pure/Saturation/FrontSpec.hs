...
contextProgram :: EGraphFront 'Authored FrontTinySig NodeCount FrontTinyContext ()
contextProgram =
  egraph $ do
...
relationProgram :: EGraphFront 'Authored FrontTinySig NodeCount FrontTinyContext Bool
relationProgram =
  egraph $ do
...
batchedSeedProgram :: EGraphFront 'Authored FrontTinySig NodeCount FrontTinyContext Bool
batchedSeedProgram =
  egraph $ do
...
duplicateSeedProgram :: EGraphFront 'Authored FrontTinySig NodeCount FrontTinyContext ()
...
duplicateRelationProgram :: EGraphFront 'Authored FrontTinySig NodeCount FrontTinyContext ()
...
duplicateRulesetProgram :: EGraphFront 'Authored FrontTinySig NodeCount FrontTinyContext ()
...
invalidContextProgram :: EGraphFront 'Authored FrontTinySig NodeCount FrontTinyContext ()
invalidContextProgram =
  egraph $ do
    _ <- contextNamed "bad context" Rain
    pure done

invalidRulesetProgram :: EGraphFront 'Authored FrontTinySig NodeCount FrontTinyContext ()
invalidRulesetProgram =
  egraph $ do
    _ <- rulesetNamed "bad ruleset" (rewriteNamed "one" (add #x zero ==> #x))
    pure done

invalidSeedProgram :: EGraphFront 'Authored FrontTinySig NodeCount FrontTinyContext ()
invalidSeedProgram =
  egraph $ do
    _ <- defNamed "bad seed" zero
    pure done

invalidRelationProgram :: EGraphFront 'Authored FrontTinySig NodeCount FrontTinyContext ()
...
reportShape :: EGraphFrontReport FrontTinySig NodeCount FrontTinyContext (MaybeExtraction Int) -> ReportShape
reportShape report =
  ReportShape
