...
emptyBladeChoiceGraph :: SaturatingContextEGraph UnitContextSiteOwner SurfaceKind (PackedNode BladeChoiceSig) ChoiceDepth ()
...
expectBladeFront ::
  Either (EGraphFrontError UnitContextSiteOwner BladeChoiceSig ChoiceDepth ()) value ->
  IO value
expectBladeFront =
  \case
    Right value ->
