...
data BlueRoseRewriteError
  = BlueRoseRewriteCompileError !BlueRoseRule !(EGraphRuleCompileError SurfaceKind Ring.RingF)
...
data BlueRoseFixtureError
  = BlueRoseFixtureCompileError !BlueRoseRule !(EGraphRuleCompileError SurfaceKind Ring.RingF)
...
compileBlueRoseRule ruleName rewriteRule =
  case first (BlueRoseFixtureCompileError ruleName) (compileRewriteRules @(EGraphU UnitContextSiteOwner SurfaceKind Ring.RingF Ring.NodeCount ()) [rewriteRule]) of
