...
fixtureChimera :: Either UnionFindAllocationError (ClassId, ClassId, ClassId, ClassId, ContextEGraph TissueF TissueCount Anatomy)
fixtureChimera = do
  ...
  pure (boneId, keratinId, chitinId, cartilageId, emptyContextEGraph anatomyLattice graph4)
