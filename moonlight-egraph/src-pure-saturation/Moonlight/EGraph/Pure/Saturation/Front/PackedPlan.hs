...
packCompiledPatternQuery ::
  ...
  Either [PatternVar] (CompiledPatternQuery (CompiledGuard capability (PackedNode sig)) (PackedNode sig))
...
unpackCompiledPatternQuery ::
  ...
  Either [PatternVar] (CompiledPatternQuery (CompiledGuard capability (Node sig)) (Node sig))
...
packCompiledPatternExtension ::
  ...
  Either [PatternVar] (CompiledPatternExtension (CompiledGuard capability (PackedNode sig)) (PackedNode sig))
...
unpackCompiledPatternExtension ::
  ...
  Either [PatternVar] (CompiledPatternExtension (CompiledGuard capability (Node sig)) (Node sig))
...
packCompiledApplicationCondition ::
  ...
  Either [PatternVar] (CompiledApplicationCondition (CompiledGuard capability (PackedNode sig)) (PackedNode sig))
packCompiledApplicationCondition =
...
unpackCompiledApplicationCondition ::
  ...
  Either [PatternVar] (CompiledApplicationCondition (CompiledGuard capability (Node sig)) (Node sig))
unpackCompiledApplicationCondition =
  fmap compiledApplicationCondition
...
packRulePlan ::
  ...
  Either [PatternVar] (RulePlan (CompiledGuard capability (PackedNode sig)) (PackedNode sig))
packRulePlan rulePlan = do
  ...
  pure
    RulePlan
      { rpId = rpId rulePlan,
        rpQuery = query,
        rpRhs = rhsInstantiationSpec (packPostMatchSubst <$> rulePlanPostSubst rulePlan) (packPattern (rulePlanRhsPattern rulePlan)),
        rpApplicationCondition = applicationCondition
      }

unpackRulePlan ::
  (RewriteSignature sig, Ord capability, Ord (NodeTag sig)) =>
  RulePlan (CompiledGuard capability (PackedNode sig)) (PackedNode sig) ->
  Either [PatternVar] (RulePlan (CompiledGuard capability (Node sig)) (Node sig))
unpackRulePlan rulePlan = do
  ...
  pure
    RulePlan
      { rpId = rpId rulePlan,
        rpQuery = query,
        rpRhs = rhsInstantiationSpec (unpackPostMatchSubst <$> rulePlanPostSubst rulePlan) (unpackPattern (rulePlanRhsPattern rulePlan)),
        rpApplicationCondition = applicationCondition
      }
...
packRulePlanSet ::
  ...
  Either [PatternVar] (RulePlanSet capability (PackedNode sig))
packRulePlanSet =
...
unpackRulePlanSet ::
  ...
  Either [PatternVar] (RulePlanSet capability (Node sig))
unpackRulePlanSet =
...
packCompiledFactRule ::
  ...
  Either [PatternVar] (CompiledFactRule capability (PackedNode sig))
packCompiledFactRule compiledFactRule = do
  compiledQuery <- packCompiledPatternQuery (cfrCompiledQuery compiledFactRule)
  pure
    CompiledFactRule
      { cfrId = cfrId compiledFactRule,
        cfrName = cfrName compiledFactRule,
        cfrQuery = packPatternQuery packRewriteCondition (cfrQuery compiledFactRule),
        cfrCompiledQuery = compiledQuery,
        cfrProjection = cfrProjection compiledFactRule,
        cfrFactId = cfrFactId compiledFactRule
      }

unpackCompiledFactRule ::
  (RewriteSignature sig, Ord capability, Ord (NodeTag sig)) =>
  CompiledFactRule capability (PackedNode sig) ->
  Either [PatternVar] (CompiledFactRule capability (Node sig))
unpackCompiledFactRule compiledFactRule = do
  compiledQuery <- unpackCompiledPatternQuery (cfrCompiledQuery compiledFactRule)
  pure
    CompiledFactRule
      { cfrId = cfrId compiledFactRule,
        cfrName = cfrName compiledFactRule,
        cfrQuery = unpackPatternQuery unpackRewriteCondition (cfrQuery compiledFactRule),
        cfrCompiledQuery = compiledQuery,
        cfrProjection = cfrProjection compiledFactRule,
        cfrFactId = cfrFactId compiledFactRule
      }
