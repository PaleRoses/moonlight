...
type EGraphApplicationResult :: Type -> Type -> (Type -> Type) -> Type
data EGraphApplicationResult c capability f = EGraphApplicationResult
  { egarTrace :: !(ContextMutationTrace c f),
...
type RewriteConstructionBatch :: Type -> (Type -> Type) -> Type -> Type -> Type
data RewriteConstructionBatch capability f a c = RewriteConstructionBatch
  { rcbBatch :: !(ContextRebaseBatch f a c),
...
stageSupportedRewriteConstruction ::
  ...
  RewriteConstructionBatch capability f a c ->
  (SupportedRewriteMatch c capability f, Maybe (Fix f)) ->
  Either (EGraphRewriteApplicationError f c) (RewriteConstructionBatch capability f a c)
...
stageConstructedRewriteMerge ::
  ...
  Either (EGraphRewriteApplicationError f c) (ContextRebaseBatch f a c)
...
egraphApplyMatchesContextualReported ::
  ...
  Either
    (EGraphRewriteApplicationError f c)
    (ApplyOutcome (EGraphApplicationResult c capability f) (ContextEGraph f a c))
...
emptyEGraphApplicationResult ::
  ContextEGraph f a c ->
  EGraphApplicationResult c capability f
...
egraphApplyMatchesBaseReported ::
  ...
  [SupportedRewriteMatch c capability f] ->
  ContextEGraph f a c ->
  Either (EGraphRewriteApplicationError f c) (ApplyOutcome (EGraphApplicationResult c capability f) (ContextEGraph f a c))
...
engineApplyMatchesWithProofReported ::
  ...
  Either
    (EGraphRewriteApplicationError f c)
    (ApplyOutcome (EGraphApplicationResult c capability f) (SaturatingProofEGraph capability f a c p))
...
applySupportedProofRewritesReported ::
  ...
  Either
    (EGraphRewriteApplicationError f c)
    (SaturatingProofEGraph capability f a c p, EGraphApplicationResult c capability f)
...
isPreparedGlobalSupport :: Eq c => PreparedContextSite c -> SupportBasis c -> Bool
isPreparedGlobalSupport site supportValue =
  either (const False) (== supportValue) (defaultPreparedSupport site)
