...
data ColoredWriteFixture = ColoredWriteFixture
  { cwfContextGraph :: !(ContextEGraph Arith.ArithF Arith.NodeCount AnatomyRegion),
...
instance NFData ColoredWriteFixture where
  rnf fixture =
...
coloredWriteBench (authoringContext, termCount) =
  env (prepareColoredWriteFixture authoringContext termCount) $ \fixture ->
    bgroup
...
prepareColoredWriteFixture :: AnatomyRegion -> Int -> IO ColoredWriteFixture
prepareColoredWriteFixture authoringContext termCount = do
  ...
  let fixture =
        ColoredWriteFixture
          { cwfContextGraph = emptyContextEGraph coarseAnatomyLattice baseGraph,
  ...
  evaluate (coloredWriteOurDigest fixture + coloredWriteMaterializedDigest fixture) *> pure fixture

coloredWriteOurDigest :: ColoredWriteFixture -> Int
...
coloredWriteMaterializedDigest :: ColoredWriteFixture -> Int
