...
activateContextMerges ::
  ...
  Either (ContextDeltaError Arith.ArithF AnatomyRegion) (ContextEGraph Arith.ArithF Arith.NodeCount AnatomyRegion)
...
adaptBenchMonoZipChild :: (K a leftSort, K a rightSort) -> K (a, a) resultSort
