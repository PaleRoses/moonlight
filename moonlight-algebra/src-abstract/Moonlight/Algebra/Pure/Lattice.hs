...
leastFixpoint ::
  ...
  (a -> a) ->
  Either (FixpointDivergence a) a
leastFixpoint budget step =
  iterateFixpointFrom budget bottom step
...
greatestFixpoint ::
  ...
  (a -> a) ->
  Either (FixpointDivergence a) a
greatestFixpoint budget step =
  iterateFixpointFrom budget top step
...
leastPreFixpoint ::
  ...
  (a -> a) ->
  Either (FixpointDivergence a) a
leastPreFixpoint budget step =
  leastPreFixpointFrom budget bottom step
...
greatestPostFixpoint ::
  ...
  (a -> a) ->
  Either (FixpointDivergence a) a
greatestPostFixpoint budget step =
  greatestPostFixpointFrom budget top step
