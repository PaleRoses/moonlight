...
programFactorProgram :: RelProgram -> Either RelExecutionError FactorProgram
programFactorProgram relProgram = do
  ...
  first RelExecutionRuntimeProgram (compileFactorProgram prPlan decomp)
{-# INLINE programFactorProgram #-}
