...
-- | Flatten every parent chain to its root, returning the compressed
-- structure.
compress :: UnionFind -> UnionFind
compress unionFind =
  snd (Transaction.runUnionFindTransaction unionFind Transaction.transactionCompress)
