...
data IndexValidationError
  ...
  | RelationRowIdCursorInvalid !IndexedRowsCursorError
...
validateRelationIndex pr =
  ...
  where
    ...
    relationCursorErrors :: [IndexValidationError]
    relationCursorErrors =
      case validateIndexedRowsCursor (relRows pr) of
        Right () -> []
        Left cursorError -> [RelationRowIdCursorInvalid cursorError]
