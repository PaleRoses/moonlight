...
import Moonlight.EGraph.Pure.Context
  ( ContextEGraph,
    ContextMergePlan,
    ContextMutationTrace (cmtDirtyContexts),
    ContextRebaseReport (..),
...
import Moonlight.EGraph.Pure.Context qualified as ContextCore
...
planStagingReportFromCommit mergeCounts rebaseReport =
  PlanStagingReport
    { psrLocalizedMerges = totalLocalizedMerges mergeCounts,
      ...
      psrDirtyContextCount = Set.size (cmtDirtyContexts (crrTrace rebaseReport))
    }
