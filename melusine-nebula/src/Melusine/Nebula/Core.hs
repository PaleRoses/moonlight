...
import Moonlight.EGraph.Pure.Extraction (ExtractionFixpointBudget (..))
...
data NebulaConfig = NebulaConfig
  { ncSaturationBudget :: !SaturationBudget,
    ncExtractionBudget :: !ExtractionFixpointBudget,
...
defaultNebulaConfig =
  NebulaConfig
    { ncSaturationBudget =
      ...
      ncExtractionBudget = ExtractionFixpointBudget 4194304,
