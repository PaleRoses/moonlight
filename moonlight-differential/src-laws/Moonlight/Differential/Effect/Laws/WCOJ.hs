...
propDenseTriangleWCOJMatchesBruteForce (TestTriangleEdges rawEdges) =
  tcTriangles (countTrianglesWCOJ (buildDenseTriangleTrie rawEdges))
    QC.=== Harness.bruteForceTriangleCount rawEdges
...
propDenseTriangleStatsReportNormalizedEdges (TestTriangleEdges rawEdges) =
  tbsEdges (triangleBenchmarkStats (buildDenseTriangleTrie rawEdges))
    QC.=== Set.size (Harness.normalizedEdgeSet rawEdges)
