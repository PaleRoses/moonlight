...
denseTrianglePathCase :: Int -> PreparedDenseTriangle
denseTrianglePathCase =
  denseTriangleCaseFromEdges . pathGraphEdges

denseTriangleStarCase :: Int -> PreparedDenseTriangle
denseTriangleStarCase =
  denseTriangleCaseFromEdges . starGraphEdges

denseTriangleCliqueCase :: Int -> PreparedDenseTriangle
denseTriangleCliqueCase =
  denseTriangleCaseFromEdges . cliqueGraphEdges

denseTriangleExactCliqueCase :: Int -> PreparedTriangleEdges
denseTriangleExactCliqueCase =
  PreparedTriangleEdges . cliqueGraphEdges

denseTriangleSkewedCase :: Int -> PreparedDenseTriangle
denseTriangleSkewedCase =
  denseTriangleCaseFromEdges . skewedTriangleGraphEdges

denseTriangleCaseFromEdges :: [(Int, Int)] -> PreparedDenseTriangle
denseTriangleCaseFromEdges =
  PreparedDenseTriangle . buildDenseTriangleTrie
