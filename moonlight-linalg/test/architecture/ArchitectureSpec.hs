...
assertSublibrarySliceDiscipline =
  assertForbiddenFragments
    ( (sourceCheckFor carrierForbiddenImports <$> carrierSliceSources)
        <> (sourceCheckFor noInPackageImports <$> structuredSliceSources)
        <> (sourceCheckFor eigenForbiddenImports <$> eigenSliceSources)
        <> (sourceCheckFor geometryForbiddenImports <$> geometrySliceSources)
        <> (sourceCheckFor denseForbiddenImports <$> denseSliceSources)
        <> (sourceCheckFor domainForbiddenImports <$> domainSliceSources)
        <> (sourceCheckFor sparseForbiddenImports <$> sparseSliceSources)
        <> (sourceCheckFor staticsForbiddenImports <$> staticsSliceSources)
        <> (sourceCheckFor spectralForbiddenImports <$> spectralSliceSources)
        <> (sourceCheckFor nativeForbiddenImports <$> nativeSliceSources)
    )
...
carrierSliceSources :: [FilePath]
carrierSliceSources =
  [ "src-carrier/Moonlight/LinAlg/Internal/DenseList.hs",
    "src-carrier/Moonlight/LinAlg/Internal/Discrete.hs",
    "src-carrier/Moonlight/LinAlg/Internal/GF2/SparseColumn.hs",
    "src-carrier/Moonlight/LinAlg/Internal/GF2/Xor.hs",
    "src-carrier/Moonlight/LinAlg/Internal/Primitives.hs",
    "src-carrier/Moonlight/LinAlg/Internal/Storage.hs",
    "src-carrier/Moonlight/LinAlg/Internal/VectorOps.hs",
    "src-carrier/Moonlight/LinAlg/Pure/Dense/Flat.hs",
    "src-carrier/Moonlight/LinAlg/Pure/Dense/Rows.hs",
    "src-carrier/Moonlight/LinAlg/Pure/Dense/Types.hs"
  ]

structuredSliceSources :: [FilePath]
structuredSliceSources =
  [ "src-structured/Moonlight/LinAlg/Pure/Structured/BlockTridiagonal.hs",
    "src-structured/Moonlight/LinAlg/Pure/Structured/Tridiagonal.hs"
  ]

eigenSliceSources :: [FilePath]
eigenSliceSources =
  [ "src-eigen/Moonlight/LinAlg/Internal/Eigen/DenseWork.hs",
    "src-eigen/Moonlight/LinAlg/Internal/Eigen/Householder.hs",
    "src-eigen/Moonlight/LinAlg/Internal/Eigen/Input.hs",
    "src-eigen/Moonlight/LinAlg/Internal/Eigen/Kernels.hs",
    "src-eigen/Moonlight/LinAlg/Internal/Eigen/Residual.hs",
    "src-eigen/Moonlight/LinAlg/Internal/Eigen/Symmetric.hs",
    "src-eigen/Moonlight/LinAlg/Internal/Eigen/Tridiagonal.hs"
  ]

geometrySliceSources :: [FilePath]
geometrySliceSources =
  [ "src-geometry/Moonlight/LinAlg/Pure/Geometry/AABB.hs",
    "src-geometry/Moonlight/LinAlg/Pure/Geometry/AABB2.hs",
    "src-geometry/Moonlight/LinAlg/Pure/Geometry/Frame.hs",
    "src-geometry/Moonlight/LinAlg/Pure/Geometry/Symmetric.hs",
    "src-geometry/Moonlight/LinAlg/Pure/Geometry/Transform/Affine.hs",
    "src-geometry/Moonlight/LinAlg/Pure/Geometry/Vec2.hs",
    "src-geometry/Moonlight/LinAlg/Pure/Geometry/Vec3.hs"
  ]

denseSliceSources :: [FilePath]
denseSliceSources =
  [ "src-dense/Moonlight/LinAlg/Internal/Backend/Core.hs",
    "src-dense/Moonlight/LinAlg/Internal/Backend/Elimination.hs",
    "src-dense/Moonlight/LinAlg/Internal/Backend/PLU.hs",
    "src-dense/Moonlight/LinAlg/Internal/Backend/RREF.hs",
    "src-dense/Moonlight/LinAlg/Internal/Backend/RowOps.hs",
    "src-dense/Moonlight/LinAlg/Internal/Backend/RowStore.hs",
    "src-dense/Moonlight/LinAlg/Internal/Backend/Smith.hs",
    "src-dense/Moonlight/LinAlg/Internal/Dense/DoubleFactorization.hs",
    "src-dense/Moonlight/LinAlg/Internal/Dense/OneSidedJacobiSVD.hs",
    "src-dense/Moonlight/LinAlg/Pure/Dense/Basic.hs",
    "src-dense/Moonlight/LinAlg/Pure/Dense/Block.hs",
    "src-dense/Moonlight/LinAlg/Pure/Dense/Decomposition.hs",
    "src-dense/Moonlight/LinAlg/Pure/Dense/Dynamic.hs",
    "src-dense/Moonlight/LinAlg/Pure/Dense/Exterior.hs",
    "src-dense/Moonlight/LinAlg/Pure/Dense/Field.hs",
    "src-dense/Moonlight/LinAlg/Pure/Dense/GF2.hs",
    "src-dense/Moonlight/LinAlg/Pure/Dense/Solver.hs"
  ]

domainSliceSources :: [FilePath]
domainSliceSources =
  [ "src-domain/Moonlight/LinAlg/Pure/Domain/Bareiss.hs",
    "src-domain/Moonlight/LinAlg/Pure/Domain/Smith.hs"
  ]

sparseSliceSources :: [FilePath]
sparseSliceSources =
  [ "src-sparse/Moonlight/LinAlg/Pure/Sparse/Assembly.hs",
    "src-sparse/Moonlight/LinAlg/Pure/Sparse/Packed.hs",
    "src-sparse/Moonlight/LinAlg/Pure/Sparse/Solver/CG.hs",
    "src-sparse/Moonlight/LinAlg/Pure/Sparse/Solver/Common.hs",
    "src-sparse/Moonlight/LinAlg/Pure/Sparse/Solver/GMRES.hs",
    "src-sparse/Moonlight/LinAlg/Pure/Sparse/Solver/IncompleteCholesky0.hs",
    "src-sparse/Moonlight/LinAlg/Pure/Sparse/Solver/Mutable.hs",
    "src-sparse/Moonlight/LinAlg/Pure/Sparse/Solver/Preconditioner.hs",
    "src-sparse/Moonlight/LinAlg/Pure/Sparse/Solver/Stationary.hs",
    "src-sparse/Moonlight/LinAlg/Pure/Sparse/Solver/Types.hs",
    "src-sparse/Moonlight/LinAlg/Pure/Sparse/Structured.hs",
    "src-sparse/Moonlight/LinAlg/Pure/Sparse/Types.hs"
  ]

staticsSliceSources :: [FilePath]
staticsSliceSources =
  [ "src-statics/Moonlight/LinAlg/Pure/Statics/Algebra.hs",
    "src-statics/Moonlight/LinAlg/Pure/Statics/Compile.hs",
    "src-statics/Moonlight/LinAlg/Pure/Statics/Core.hs",
    "src-statics/Moonlight/LinAlg/Pure/Statics/Network.hs",
    "src-statics/Moonlight/LinAlg/Pure/Statics/Types.hs"
  ]

spectralSliceSources :: [FilePath]
spectralSliceSources =
  [ "src-spectral/Moonlight/LinAlg/Pure/Krylov/Arnoldi.hs",
    "src-spectral/Moonlight/LinAlg/Pure/Krylov/Block.hs",
    "src-spectral/Moonlight/LinAlg/Pure/Krylov/Config.hs",
    "src-spectral/Moonlight/LinAlg/Pure/Krylov/Decomposition.hs",
    "src-spectral/Moonlight/LinAlg/Pure/Krylov/Internal.hs",
    "src-spectral/Moonlight/LinAlg/Pure/Krylov/Lanczos.hs",
    "src-spectral/Moonlight/LinAlg/Pure/Krylov/Projected.hs",
    "src-spectral/Moonlight/LinAlg/Pure/Krylov/SelectedTridiagonal.hs",
    "src-spectral/Moonlight/LinAlg/Pure/Krylov/Selection.hs",
    "src-spectral/Moonlight/LinAlg/Pure/Operator.hs",
    "src-spectral/Moonlight/LinAlg/Pure/Operator/Internal.hs",
    "src-spectral/Moonlight/LinAlg/Pure/Spectral/Request.hs",
    "src-spectral/Moonlight/LinAlg/Pure/Spectral/Result.hs",
...
nativeSliceSources :: [FilePath]
nativeSliceSources =
  [ "src-native/Moonlight/LinAlg/Effect/Native/Dispatch.hs",
    "src-native/Moonlight/LinAlg/Effect/Native/LAPACK.hs"
  ]
