...
[`moonlight-core`](https://hackage.haskell.org/package/moonlight-core), it provides a totalised,
...
Moonlight's original code is licensed under MIT; see [`LICENSE`](./LICENSE).
