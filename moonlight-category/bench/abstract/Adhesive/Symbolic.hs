...
symbolicLimitBenchmarks =
  bgroup
    "limits"
    [ bench "pullback witness batch x512" (nf (batchWeight pullbackWeight) sampleBatch),
      bench "pullback mediator batch x512" (nf (batchWeight pullbackMediatorWeight) sampleBatch),
      bench "pushout witness batch x512" (nf (batchWeight pushoutWeight) sampleBatch)
    ]
...
symbolicAdhesiveBenchmarks =
  bgroup
    "adhesive"
    [ bench "witnessMonic batch x512" (nf (batchWeight monicWitnessWeight) sampleBatch),
      bench "pushoutComplement witness batch x512" (nf (batchWeight pushoutComplementWeight) sampleBatch),
      bench "pushoutComplement square commute check batch x512" (nf (batchWeight pushoutComplementCommuteWeight) sampleBatch)
    ]
...
symbolicPBPObenchmarks =
  bgroup
    "PBPO"
    [ bench "pbpoComplement witness batch x512" (nf (batchWeight pbpoComplementWeight) sampleBatch),
      bench "pbpo pullback square commute check batch x512" (nf (batchWeight pbpoPullbackCommuteWeight) sampleBatch),
      bench "pbpo pushout square commute check batch x512" (nf (batchWeight pbpoPushoutCommuteWeight) sampleBatch)
    ]
