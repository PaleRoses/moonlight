...
galoisBenchmarks =
  bgroup
    "Galois"
    [ bench "alpha/gamma round trip batch x512" (nf galoisRoundTripBatchWeight sampleBatch),
      bench "threshold enumeration batch x512" (nf (batchWeight galoisThresholdWeight) sampleBatch)
    ]
sampleBatch :: [Int]
sampleBatch = [0 .. 511]
