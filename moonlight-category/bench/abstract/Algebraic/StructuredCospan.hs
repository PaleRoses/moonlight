...
structuredCospanBenchmarks =
  bgroup
    "StructuredCospan"
    [ bench "mkStructuredCospan left batch x512" (nf (batchWeight structuredCospanBuildWeight) sampleBatch),
      bench "composeStructuredCospan batch x512" (nf (batchWeight structuredCospanComposeWeight) sampleBatch)
    ]
