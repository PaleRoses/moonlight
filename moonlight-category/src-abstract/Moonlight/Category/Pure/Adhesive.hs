...
denseIntSetFull universeSize = do
  ...
  pure
    ( denseIntSetFromWords
        universeSize
        (denseFullWord universeSize 0)
        (denseFullWord universeSize 1)
        (denseFullWord universeSize 2)
        (denseFullWord universeSize 3)
        (denseFullWord universeSize 4)
        (denseFullWord universeSize 5)
        (denseFullWord universeSize 6)
        (denseFullWord universeSize 7)
    )
...
denseIntSetIsSubsetOf left right =
...
denseFullWord :: Int -> Int -> Word64
denseFullWord universeSize wordIndex =
  denseMaskForWord universeSize wordIndex
{-# INLINE denseFullWord #-}
