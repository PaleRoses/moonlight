...
module Moonlight.Category.Pure.Indexed.NaturalTransformation (
...
-- | t'Apply' is a bifunctor; @Apply :% (f, a)@ applies @f@ to @a@.
...
-- | t'Tuple' converts an object @a@ to the functor t'Tuple1' @a@.
