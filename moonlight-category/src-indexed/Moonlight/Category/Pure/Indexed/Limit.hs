...
module Moonlight.Category.Pure.Indexed.Limit (
...
import GHC.Exts (FUN, Multiplicity (One))
...
import Moonlight.Category.Pure.Indexed.Adjunction

import Moonlight.Category.Pure.Indexed.Product
import Moonlight.Category.Pure.Indexed.Coproduct
import Moonlight.Category.Pure.Indexed.Unit
import Moonlight.Category.Pure.Indexed.Void
...
adjColimitFactorizer :: Adjunction k (Nat j k) l (Diag j k) -> Cocone j k f n -> k (l :% f) n
...
-- | If @k@ has binary products, we can take the limit of two joined diagrams.
...
-- | The product of categories t':**:' is the binary product in 'Cat'.
...
-- | The functor product t':*:' is the binary product in functor categories.
...
-- | If @k@ has binary coproducts, we can take the colimit of two joined diagrams.
...
-- | The coproduct of categories t':++:' is the binary coproduct in 'Cat'.
...
-- | The functor coproduct t':+:' is the binary coproduct in functor categories.
