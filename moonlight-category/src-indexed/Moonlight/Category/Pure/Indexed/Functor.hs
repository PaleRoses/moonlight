...
module Moonlight.Category.Pure.Indexed.Functor (
...
newtype Any f = Any f deriving newtype Functor


data Proj1 (c1 :: Type -> Type -> Type) (c2 :: Type -> Type -> Type) = Proj1

-- | t'Proj1' is a bifunctor that projects out the first component of a product.
...
-- | t'Proj2' is a bifunctor that projects out the second component of a product.
...
-- | t'DiagProd' is the diagonal functor for products.
...
-- | t'Tuple1' tuples with a fixed object on the left.
...
-- | Swaps the two categories of a product category.
...
-- | t'Tuple2' tuples with a fixed object on the right.
